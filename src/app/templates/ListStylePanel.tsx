/**
 * @file templates/ListStylePanel.tsx
  ...
  return (
    <div className="flex items-center gap-1">
      <Input
        ...
        disabled={disabled}
      />
      <span className={`text-xs text-mylo-text-tertiary${disabled ? ' opacity-40' : ''}`}>
        pt
      </span>
    </div>
  );
...
interface ListStylePanelProps {
  /** Which list style this panel is editing — controls breadcrumb label and marker options. */
