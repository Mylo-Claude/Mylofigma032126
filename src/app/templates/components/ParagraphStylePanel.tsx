/**
 * @file templates/components/ParagraphStylePanel.tsx
...
interface ParagraphStylePanelProps {
  /** Which paragraph style this panel is editing — controls header label. */
...
export function ParagraphStylePanel({
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      {/* ── Footer ── */}
      <div className="px-4 py-3 border-t border-mylo-border-light shrink-0 flex items-center gap-2 bg-mylo-surface-subtle">
